...
urlpatterns = [
    ...
    path('AddProductInvoiceRturned/<int:pk>/', AddProductInvoiceRturned, name='AddProductInvoiceRturned'),
    ...
    path('InvoiceProductsDeleteReturned/<int:pk>/<int:id>/', InvoiceProductsDeleteReturned.as_view(), name='InvoiceProductsDeleteReturned'),
